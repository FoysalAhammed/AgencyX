...
const CustomerSupport = () => {
  return (
    <section className="row-gap-8 mx-auto grid gap-5 py-5 md:py-16 lg:mt-5 lg:grid-cols-2 lg:gap-12 lg:py-20">
      <div className="mx-auto flex max-w-xl flex-col justify-center text-center md:text-start lg:mb-6">
        <h1 className="text-3xl font-bold sm:text-4xl md:mx-auto text-center mb-6 text-current md:text-start">
        ...
        <p className="text-base text-gray-400 md:text-lg">
          ...
          <span>
            Where Course Instructor Foysal Ahammed And 4-5 Others Software
      ...
      <div
        className="relative shadow-black/5 max-w-fit shadow-none rounded-large"
      ...
      >
        <Image
          ...
          height={500}
          src="/contact.png"
          className="relative z-10   shadow-black/5 data-[loaded=true]:opacity-100 shadow-none transition-transform-opacity motion-reduce:transition-none !duration-300 rounded-large mt-5"
          alt=""
        />
      </div>
    </section>
